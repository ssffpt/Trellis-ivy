...
| [Trellis Core SDK](./trellis-core-sdk.md) | `trellis-ivy-core` / CLI package boundary, public exports, build and versioning contracts | Done |
...
- Editing `packages/core/**`, moving reusable CLI logic into core, or changing CLI imports from `trellis-ivy-core` → [trellis-core-sdk.md](./trellis-core-sdk.md)
