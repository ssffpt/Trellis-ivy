...
| [Trellis Core SDK](./trellis-core-sdk.md) | `@liushuang/trellis-core` / CLI package boundary, public exports, build and versioning contracts | Done |
...
- Editing `packages/core/**`, moving reusable CLI logic into core, or changing CLI imports from `@liushuang/trellis-core` → [trellis-core-sdk.md](./trellis-core-sdk.md)
