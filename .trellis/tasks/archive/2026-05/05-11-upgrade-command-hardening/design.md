...
- build `npm install -g trellis-ivy@<tag>`
...
```text
command: npm
args: install -g trellis-ivy@<tag>
...
```text
command: cmd.exe
args: /d /s /c npm install -g trellis-ivy@<tag>
options: { stdio: "inherit", shell: false }
```
...
```text
Run: npm install -g trellis-ivy@beta
```
...
- Manual command: npm install -g trellis-ivy@beta
```
