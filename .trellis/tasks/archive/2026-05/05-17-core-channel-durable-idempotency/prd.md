...
Add durable idempotency to `trellis-ivy-core` channel writes so replayed commands can return the original event instead of appending duplicate JSONL events.
