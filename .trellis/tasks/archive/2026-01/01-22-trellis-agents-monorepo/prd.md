...
2. **Extract `packages/core`**
   ...
   - Create `packages/core/package.json` as `trellis-ivy-core`
...
3. **Extract `packages/shared`**
   ...
   - Create `packages/shared/package.json` as `trellis-ivy-shared`
...
4. **Migrate CLI to `apps/cli`**
   ...
   - Keep `trellis-ivy` as package name for npm publishing
...
│   │   ├── bin/
│   │   └── package.json
│   └── electron/               # trellis-ivy-app (new GUI)
│       ├── src/
│       │   ├── main/
│       │   ├── preload/
│       │   └── renderer/
│       └── package.json
├── packages/
│   ├── core/                   # trellis-ivy-core
│   │   ├── src/
│   │   │   ├── types/
│   │   │   └── constants/
│   │   └── package.json
│   └── shared/                 # trellis-ivy-shared
│       ├── src/
│       │   ├── utils/
│       │   ├── templates/
│       │   └── migrations/
...
- Use workspace protocol for internal deps: `"trellis-ivy-core": "workspace:*"`
- Preserve `trellis-ivy` package name for backward compatibility
