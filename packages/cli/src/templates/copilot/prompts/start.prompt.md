...
- **Active task status `planning` + `prd.md` exists** → stay in Phase 1. Lightweight tasks can be PRD-only; standard tasks need `design.md`. Load the relevant Phase 1 step detail before `task.py start`.
