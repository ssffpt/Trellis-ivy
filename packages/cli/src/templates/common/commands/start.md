...
- **Active task status `planning` + `prd.md` exists** → stay in Phase 1. Lightweight tasks can be PRD-only; complex tasks need prd.md with 技术决策 section. Load the relevant Phase 1 step detail before `task.py start`.
