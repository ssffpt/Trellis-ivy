...
| `planning` | complex task missing `design.md` | complete missing planning artifacts |
| `planning` | complex task has `prd.md` and `design.md` | ask for start review, then run `task.py start` |
