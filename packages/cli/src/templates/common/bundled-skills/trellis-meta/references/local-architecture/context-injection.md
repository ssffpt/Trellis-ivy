...
| task context | `.trellis/tasks/<task>/prd.md`, `research/` | Current task requirements and research. |
...
In both modes, JSONL files in the task directory are the manifest for spec/research context. Task artifacts are read separately: `prd.md`.
