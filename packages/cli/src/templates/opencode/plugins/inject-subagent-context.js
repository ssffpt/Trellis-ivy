...
2. **Understand task artifacts** - Read requirements and execution plan if present
...
2. **Verify task artifacts** - Check prd.md and implement.md
...
- Verify implement.md constraints when that file is present` :
