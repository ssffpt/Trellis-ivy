...
export function buildPullBasedPrelude(agentType: SubAgentType): string {
  ...
  // review and premise-challenger only need prd.md.
...
2. If \`<task-path>/premise-challenges.md\` exists, read it as well (needed for review dimension 5).
