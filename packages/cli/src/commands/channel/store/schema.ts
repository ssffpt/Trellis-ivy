 ...
 *
 * Canonical source: `trellis-ivy-core/channel`. This module is
...
import { buildContextEntries } from "trellis-ivy-core/channel";
import type { ContextEntry } from "trellis-ivy-core/channel";
