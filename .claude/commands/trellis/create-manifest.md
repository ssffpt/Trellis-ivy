...
5. `@liushuang/trellis` and `@liushuang/trellis-core` versions still match.
...
npx -y @liushuang/trellis@<last-ga> init -y -u test --claude --cursor --<platforms>
